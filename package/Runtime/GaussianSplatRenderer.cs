...
namespace GaussianSplatting.Runtime
{
    class GaussianSplatRenderSystem
    {
        ...
        public Material SortAndRenderSplats(Camera cam, CommandBuffer cmb)
        {
            ...
            foreach (var kvp in m_ActiveSplats)
            {
                ...
                if (Time.frameCount - gs.m_LastSortedFrame >= gs.m_SortNthFrame - 1
                    && (!gs.m_CenterEyeOnly || gs.m_LastSortedFrame != Time.frameCount)
    ...
    public class GaussianSplatRenderer : MonoBehaviour
    {
        ...
        [SerializeField] public Camera m_centerEyeCamera;
        ...
        public bool HasValidRenderSetup => m_GpuPosData != null && m_GpuOtherData != null && m_GpuChunks != null && m_GpuView != null && m_GpuSortKeys != null;
        ...
        public void UpdateSortingType(GpuSorting.SortType sortType)
        {
            m_CSSplatUtilities = sortType switch
            {
                ...
                _ => m_CSSplatUtilities_deviceRadixSort
            };
        ...
        public void Update()
        {
            ...
            // Only rebuild resources when the asset actually changes
            ...
            // Refresh camera reference cheaply (no rebuild)
            if (m_centerEyeCamera == null)
                m_centerEyeCamera = Camera.main;
            ...
            // Only update center eye matrix if camera exists
